...
#define STEERING_MECHANICAL_MAX_DEG    180.0f     // 조향축 기계적 양의 한계 [deg]
#define STEERING_MECHANICAL_MIN_DEG   -180.0f     // 조향축 기계적 음의 한계 [deg]
...
#define MOTOR_MAX_FREQ_HZ               20000U   // 개루프 제어 운용 상한 (MOTOR_DRIVER_MAX_FREQ_HZ 이하로 설정할 것)
#define MOTOR_DIRECTION_GUARD_MS        1U        // 방향 반전시 대기시간(ms)

/* =========================================
 * control.c
 * ========================================= */
#define CONTROL_TARGET_MAX_STEERING_DEG      180.0f      // 제어 목표 조향각 상한 [deg] (STEERING_MECHANICAL_MAX_DEG 이하로 설정할 것)
#define CONTROL_TARGET_MIN_STEERING_DEG     -180.0f      // 제어 목표 조향각 하한 [deg]
#define CONTROL_REACHED_BAND_STEERING_DEG    0.5f       // 도달 판정 조향각 오차 범위 [deg]

#define CONTROL_DEFAULT_KP                   100.0f     // P 게인 [Hz/motor_deg]
#define CONTROL_DEFAULT_KI                     0.0f       // I 게인
#define CONTROL_DEFAULT_KD                     0.0f       // D 게인
#define CONTROL_INTEGRAL_LIMIT                50.0f    // 적분항 누적 제한
#define CONTROL_OUTPUT_LIMIT_HZ            20000.0f   // 폐루프 제어 운용 상한 (MOTOR_MAX_FREQ_HZ 이하로 설정할 것)

/* =========================================
 * ethernet.c
 * ========================================= */
#define ETHERNET_ASMS_MAX_STEERING_DEG       180.0f
#define ETHERNET_ASMS_MIN_STEERING_DEG      -180.0f

#define ETHERNET_PC_MAX_STEERING_DEG         180.0f
#define ETHERNET_PC_MIN_STEERING_DEG        -180.0f
